...
// ==========================================
// 2. CROSS-PLATFORM RECURSIVE FILE WATCHER (Linux inotify + Windows/macOS)
// ==========================================
...
function initFileWatcher(targetDir) {
  ...
  // Deep directory tree watch across all OS platforms (resolves Linux inotify recursion constraint)
...
// ==========================================
// 3. REAL ENVIRONMENT & METEOROLOGICAL TELEMETRY API
// ==========================================
...
// ==========================================
// 4. AUTONOMOUS AGENT IPC & LEXICAL CONTRACT EXTRACTOR
// ==========================================
async function dispatchAgentProcess(payload, baseDir) {
  ...
  if (cliAvailable) {
    try {
      ...
      console.log('[AGENT IPC] Falling back to deterministic Lexical Contract Extractor.');
    }
  }

  // 2. Deterministic Lexical / Regex-based Contract Extractor
